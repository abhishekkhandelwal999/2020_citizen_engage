...
public class WardController extends Controller{
    ...
    public CompletionStage<Result> login() {
        ...
        String Wardname = j.get("Name").asText();
        String Password = j.get("Password").asText();
        return wardRepository.login(Wardname,Password).thenApplyAsync(us->{

           String s="{\"Wardname\":\""+us.Name+"\",\"Password\":\""+us.Password+"\",\"Category\":\""+us.Category+"\"}";
